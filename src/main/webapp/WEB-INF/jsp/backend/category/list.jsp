...
function gotoEdit(id) {
	self.location.href = "gotoEditBlogCategoryPage.do?id="+id;
}
	$(function() {
		queryMessage(1);
		...
		$('#addnew').click(function() {
			...
			window.location.href = "gotoAddBlogCategoryPage.do";
		});
	...
	function del(id) {
		if (confirm("Are your sure to delete？")) {
			window.location.href = "adminDeleteBlogCategory.do?id="+id;
		}
	}
</script>