...
<body>
<form action="adminUpdateLink.do" method="post" class="definewidth m20">
<input type="hidden" name="id" value="${data.id }" />
<table class="table table-bordered table-hover ">
    <tr>
        <td width="10%" class="tableleft">Name</td>
        <td><input type="text" name="name" required="required" class="input-xxlarge" value="${data.name }"></td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">URL</td>
        <td><input type="text" name="url" required="required" class="input-xxlarge" value="${data.url }"></td>
    </tr>
    <tr>
