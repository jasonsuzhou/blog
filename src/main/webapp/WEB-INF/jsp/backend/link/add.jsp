...
<form action="addLinkCommit.do" method="post">
<table class="table table-bordered table-hover definewidth m10">
    <tr>
        <td width="10%" class="tableleft">Name</td>
        <td>
        	<input type="text" name="name" required="required" class="input-xxlarge">
        </td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">URL</td>
        <td>
        	<input type="text" name="url" required="required" class="input-xxlarge">
        </td>
    </tr>
    <tr>
