...
function gotoEdit(id) {
	self.location.href = "gotoEditMomentsPage.do?id="+id;
}
	$(function() {
		queryMessage(1);
		...
		$('#addnew').click(function() {
			...
			window.location.href = "gotoAddMomentsPage.do";
		});
	...
	function del(id) {
		if (confirm("Are your sure to delete？")) {
			window.location.href = "adminDeleteMoments.do?id="+id;
		}
	}
</script>